...
/**
 * Botões de compartilhamento social + botão de copiar link.
 * Sem SDKs externos — apenas URLs de intenção de cada plataforma.
 */
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        {socialLinks.map(({ label, href, icon }) => (
          <a
            ...
            className="flex items-center gap-2 border border-gold/15 px-4 py-2.5 font-label text-[9px] uppercase tracking-widest text-muted hover:text-gold hover:border-gold/40 transition-all duration-200"
          >
            {icon}
            {label}
          </a>
        ...
        <button
          ...
          className={`flex items-center gap-2 border px-4 py-2.5 font-label text-[9px] uppercase tracking-widest transition-all duration-200 ${
            copied
