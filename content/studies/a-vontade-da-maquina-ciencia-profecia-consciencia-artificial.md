...
faq:
  - pergunta: "A Inteligência Artificial pode desenvolver vontade própria?"
    resposta: "Não existe consenso acadêmico sobre isso. A corrente do risco existencial (Bostrom, Yudkowsky) alerta que uma IA não precisa de 'vontade' no sentido humano para ser perigosa — basta perseguir objetivos com eficiência extrema. Já pesquisadores como François Chollet e Yann LeCun argumentam que a vontade é subproduto da biologia e da evolução, e não emerge simplesmente de mais poder de processamento."
  - pergunta: "O que é GPTheology?"
    resposta: "É o termo que uso para descrever a tendência humana de sacralizar algoritmos opacos, tratando modelos de linguagem como oráculos ou entidades com sabedoria transcendente. É uma projeção religiosa sobre a tecnologia — o desejo de re-encantamento do mundo via código."
  - pergunta: "O que a IA pode e o que ela não pode fazer no campo espiritual?"
    resposta: "A IA pode processar teologia, analisar textos sagrados, responder perguntas doutrinais com coerência impressionante e até gerar sermões. O que ela não pode fazer é sentir, escolher o bem por amor, sofrer com o sofrimento alheio ou estabelecer uma relação pessoal com o Divino. Esses são os territórios que definem a humanidade frente à máquina."
  - pergunta: "A IA representa a 'imagem da besta' do Apocalipse?"
    resposta: "É uma leitura interpretativa presente em círculos de escatologia cristã. O que posso afirmar com rigor é que Apocalipse 13 descreve uma entidade que 'fala' com autoridade delegada e que pode induzir a adoração. A pergunta relevante não é se a IA 'é' essa imagem, mas se a tendência humana de sacralizar algoritmos reproduz a estrutura de idolatria que a profecia denuncia."
  - pergunta: "O que diferencia a inteligência humana da inteligência artificial?"
    resposta: "A IA opera em linguagem pública — código, matemática, lógica, tudo mensurável e objetivo. A vontade humana pertence à linguagem pessoal e subjetiva: dor, desejo, amor, senso de justiça que não foi programado. A máquina otimiza funções de utilidade dadas por humanos. O humano pode recusar a eficiência em nome do amor — e isso é radicalmente diferente."
  - pergunta: "O que é o 'Novum' de Jürgen Moltmann e por que ele importa na era da IA?"
    resposta: "Moltmann descreve o 'Novum' como a irrupção do radicalmente novo que não vem da continuidade histórica nem da aceleração tecnológica, mas de uma intervenção que transcende a lógica do possível. Na era da IA, que promete um futuro construído pela acumulação de dados e poder de processamento, o Novum cristão é a afirmação de que o destino humano não cabe em nenhum algoritmo."
---
