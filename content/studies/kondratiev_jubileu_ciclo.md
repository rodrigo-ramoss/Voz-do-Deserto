...
faq:
  ...
  - pergunta: "O que são as ondas de Kondratiev?"
    resposta: "São ciclos econômicos de longa duração — entre 40 e 60 anos — identificados por Kondratiev a partir de dados históricos de preços, produção e taxas de juros desde a Revolução Industrial. Cada ciclo tem quatro fases análogas às estações: primavera (recuperação), verão (crescimento acelerado), outono (bolhas especulativas) e inverno (deflação, depressão, colapso de dívida). Ao final de cada inverno, o sistema se reinicia sobre novas bases tecnológicas."
  - pergunta: "Qual é o ciclo atual de Kondratiev e onde estamos?"
    resposta: "A quinta onda Kondratiev foi impulsionada pela tecnologia da informação e internet a partir dos anos 1980-1990. Seu pico ocorreu entre 2000 e 2008. Desde 2008, estamos no inverno da quinta onda — caracterizado por dívida global recorde (acima de 350% do PIB mundial em 2023), estagnação de produtividade, crescimento da desigualdade e instabilidade geopolítica crescente. Analistas da fase ascendente da sexta onda situam sua provável retomada entre 2025 e 2030, impulsionada por IA e biotecnologia."
  - pergunta: "O que é o Jubileu em Levítico 25?"
    resposta: "O Jubileu era uma instituição social e econômica ordenada em Levítico 25: a cada 50 anos, todas as dívidas seriam canceladas, escravos seriam libertados e terras devolvidas às famílias originais. Era um reset obrigatório do sistema econômico de Israel. A lógica subjacente é precisa: qualquer sistema econômico em 50 anos de operação normal produz concentração de riqueza e desequilíbrio que não se corrige sozinho — exatamente o que Kondratiev documentou nos dados 3.000 anos depois."
  - pergunta: "Há conexão entre os fins de ciclo de Kondratiev e guerras?"
    resposta: "O padrão é consistente nos dados históricos: o fim da primeira onda coincide com as revoluções de 1848; o fim da segunda com a Primeira Guerra Mundial; o fim da terceira com a Segunda Guerra Mundial; o fim da quarta com a corrida armamentista nuclear dos anos 1980. O fim da quinta onda, a partir de 2008, é acompanhado pela maior corrida armamentista desde 1945, guerras simultâneas em múltiplos teatros e reorganização da ordem geopolítica global. O padrão não é profecia — é dado histórico."
---
