...
keywords: ["#JesusHistórico", "#DesigrejadosBrasil", "#CríticaReligiosa", "#ReinoDeDeusAqui", "#VozDoDeserto"]
faq:
  - pergunta: "O Jesus histórico é diferente do Jesus pregado nas igrejas?"
    resposta: "Sim. A ciência histórica, com base em Sociologia, Arqueologia e Antropologia, revela um Jesus camponês galileu inserido numa luta política e social real, bem diferente da figura etérea construída por séculos de dogma institucional."
  - pergunta: "Jesus pretendia fundar uma nova religião?"
    resposta: "Não há evidências históricas de que Jesus tivesse essa intenção. Ele era um judeu devoto que agia dentro da tradição profética de Israel, contestando o sistema sacerdotal corrupto, não propondo uma nova instituição."
  - pergunta: "Por que Jesus foi crucificado?"
    resposta: "A crucificação era a pena máxima romana reservada a insurretos e subversivos políticos. Jesus foi executado porque sua pregação do Reino de Deus era percebida como uma ameaça concreta ao poder de Roma e da aristocracia do Templo."
  - pergunta: "O que Jesus entendia por 'Reino de Deus'?"
    resposta: "Para pesquisadores como E.P. Sanders e John Dominic Crossan, o Reino de Deus para Jesus não era uma promessa de céu pós-morte, mas uma esperança de restauração concreta e histórica de Israel — uma transformação real da ordem social presente."
  - pergunta: "Por que as igrejas não pregam o Jesus histórico?"
    resposta: "Porque o Jesus histórico é inconveniente para estruturas de poder. Um camponês que atacou o sistema financeiro do Templo, comia com marginalizados e morreu como criminoso político não se encaixa facilmente num projeto de gestão religiosa institucional."
  - pergunta: "Quais são as principais fontes acadêmicas sobre o Jesus histórico?"
    resposta: "As obras de John Dominic Crossan (O Jesus Histórico, 1991), E.P. Sanders (Jesus e o Judaísmo, 1985) e John P. Meier (Um Judeu Marginal) são referências centrais da chamada Terceira Busca pelo Jesus histórico, metodologicamente baseada em Arqueologia, Antropologia e análise textual."
---
