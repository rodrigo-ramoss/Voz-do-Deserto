...
keywords: ["#CapitalismoDeVigilância", "#Privacidade", "#BigOther", "#FéETecnologia", "#VozDoDeserto"]
faq:
  - pergunta: "O que é capitalismo de vigilância?"
    resposta: "É o termo criado pela professora de Harvard Shoshana Zuboff para descrever o modelo econômico em que empresas de tecnologia transformam a experiência humana em matéria-prima para dados comportamentais. Esses dados são usados para prever e modificar seu comportamento em benefício de terceiros — anunciantes, políticos, corporações — sem seu consentimento significativo."
  - pergunta: "O que Zuboff chama de 'Big Other'?"
    resposta: "É a arquitetura computacional ubíqua — dispositivos, algoritmos e sensores interligados — que conhece e molda o comportamento humano de forma invisível. Diferente do 'Grande Irmão' orwelliano, o Big Other não precisa de um Estado totalitário: opera através do capitalismo de mercado, tornando a vigilância lucrativa em vez de política."
  - pergunta: "Existe diferença entre o Deus que 'tudo vê' da Bíblia e o olhar do capitalismo de vigilância?"
    resposta: "Sim, e é uma diferença radical. O Deus bíblico que conhece cada cabelo da sua cabeça (Mt 10.30) é o mesmo que escolheu morrer por quem conhecia. O conhecimento no capitalismo de vigilância existe para ser monetizado — seus dados valem porque preveem seu comportamento futuro para vendê-lo a anunciantes. Um olhar é amor. O outro é extração."
  - pergunta: "Vigilância digital e liberdade de fé têm relação?"
    resposta: "Diretamente. Zuboff documenta que o capitalismo de vigilância infiltra-se em práticas religiosas, lazer, trabalho e política. Comunidades religiosas que usam plataformas digitais sem consciência crítica são transparentes para sistemas de predição comportamental — o que levanta questões sérias sobre autonomia espiritual e liberdade de consciência."
  - pergunta: "Existe resposta cristã ao capitalismo de vigilância?"
    resposta: "A tradição profética bíblica tem muito a dizer: Amós denunciou sistemas que monetizavam os pobres; Jesus atacou estruturas que mediavam o acesso ao sagrado com pedágio. A resposta cristã ao capitalismo de vigilância não é fuga tecnológica, mas recusa de participar de sistemas que tratam a pessoa humana como recurso a ser extraído."
  - pergunta: "Como posso proteger minha privacidade digital sem virar um paranoico?"
    resposta: "Consciência, não paranoia. Entender que seu smartphone é um dispositivo de coleta de dados é o primeiro passo. Usar navegadores com menos rastreamento, revisar permissões de aplicativos, e adotar ferramentas de comunicação criptografada são escolhas éticas acessíveis. A questão não é desaparecer do mundo digital — é recusar que sua existência seja reduzida a pontos de dados monetizáveis."
---
