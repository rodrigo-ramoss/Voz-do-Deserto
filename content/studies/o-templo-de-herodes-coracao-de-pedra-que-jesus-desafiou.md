...
keywords: ["#TemploDeHerodes", "#JesusHistórico", "#EstadoTemplo", "#DesigrejadosBrasil", "#VozDoDeserto"]
faq:
  - pergunta: "O Templo de Herodes era apenas um lugar de oração?"
    resposta: "Não. O Templo funcionava como o centro nervoso econômico, financeiro e político de toda a Palestina. Gerava emprego para cerca de 18 mil pessoas, controlava o câmbio de moedas, o comércio de animais para sacrifício e servia de sede do Sinédrio, o mais alto tribunal judeu. Era, na prática, um Estado dentro do Estado romano."
  - pergunta: "Por que Jesus expulsou os vendilhões do Templo?"
    resposta: "A expulsão dos vendilhões foi um ato político e profético, não uma limpeza ritual. O sistema de câmbio e venda de animais no Templo gerava lucro abusivo para a aristocracia sacerdotal às custas dos camponeses. Ao virar as mesas, Jesus atacava o motor financeiro que sustentava a cumplicidade entre a elite sacerdotal e Roma."
  - pergunta: "O que Jesus quis dizer ao profetizar a destruição do Templo?"
    resposta: "Ao anunciar que não ficaria pedra sobre pedra, Jesus declarava que a ordem sustentada pelo Templo — a aliança entre poder religioso e poder imperial — estava condenada. Para as autoridades, isso era traição sediciosa. O Templo caiu de fato em 70 d.C., destruído pelas legiões de Tito."
  - pergunta: "Jesus queria reformar o Templo ou substituí-lo?"
    resposta: "A evidência histórica aponta para substituição, não reforma. Na Última Ceia, Jesus instituiu um novo rito — pão e vinho em comunidade — que tornava teologicamente desnecessário o sistema sacrificial do Templo. O santuário de pedra era trocado por uma comunidade viva."
  - pergunta: "Qual era o tamanho e a riqueza do Templo de Herodes?"
    resposta: "Era considerado uma das sete maravilhas do mundo antigo. A plataforma do Monte do Templo era a maior estrutura artificial do mundo antigo — equivalente a mais de 25 campos de futebol. Coberto de ouro e mármore branco, o Talmude registra: 'Quem não viu o templo de Herodes, nunca viu um belo prédio.'"
  - pergunta: "Qual é a conexão entre o Templo de Herodes e as igrejas de hoje?"
    resposta: "A mesma lógica que operava no Templo — acesso mediado, hierarquia religiosa, comércio espiritual e cumplicidade com o poder — reaparece em estruturas religiosas de todas as épocas. O confronto de Jesus com o Templo é um espelho permanente para qualquer instituição que coloque sua própria manutenção acima das pessoas que deveria servir."
---
