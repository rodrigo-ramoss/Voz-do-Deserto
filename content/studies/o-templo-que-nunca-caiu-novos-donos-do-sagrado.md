...
keywords: ["#NovosSumosSacerdotes", "#IgrejaEPoder", "#TemploQueNuncaCaiu", "#DesigrejadosBrasil", "#VozDoDeserto"]
faq:
  - pergunta: "O que foi o Estado-Templo e por que ele é relevante hoje?"
    resposta: "O Estado-Templo era o modelo político-religioso do Templo de Herodes: lei religiosa como lei civil, Sumo Sacerdote como autoridade máxima, monopólio do câmbio e do comércio espiritual. É relevante hoje porque essa mesma lógica — fusão de poder religioso e político, acesso mediado ao sagrado, arrecadação como estratégia de controle — reaparece em estruturas religiosas contemporâneas."
  - pergunta: "O que é a Teologia da Prosperidade e qual é sua relação com o Templo de Herodes?"
    resposta: "A Teologia da Prosperidade é a doutrina que associa fé a bênção material e dízimo a retorno financeiro. Estruturalmente, reproduz a lógica do câmbio obrigatório do Templo: o acesso à graça de Deus é mediado por um pagamento ao sistema. A diferença é que em vez de didracma do santuário, a moeda é o dízimo, a semente, a oferta de fé."
  - pergunta: "A bancada evangélica brasileira é comparável ao Sinédrio do século I?"
    resposta: "A comparação é analítica, não pejorativa. Tanto o Sinédrio quanto a bancada evangélica representam a fusão de interesse religioso com controle do Estado — usando a identidade de fé como capital político, trocando apoio eleitoral por concessões e privilégios. A estrutura de troca de poder é semelhante, mesmo que os contextos sejam distintos."
  - pergunta: "Quem são os '16 milhões de desigrejados' no Brasil e por que saíram das igrejas?"
    resposta: "São brasileiros que se identificam como cristãos mas não frequentam nenhuma instituição religiosa. Pesquisas indicam que parte significativa saiu após perceber a fusão entre fé e projeto de poder — pastores milionários, cobrança compulsória de dízimo, alinhamento político explícito e tratamento da graça como mercadoria. Reconheceram o sistema do Templo mesmo sem ter esse nome para ele."
  - pergunta: "Críticar igrejas é ateísmo ou anticristianismo?"
    resposta: "Não. A crítica mais radical ao sistema religioso institucionalizado registrada na história foi feita pelo próprio Jesus — dentro do Templo, com um chicote de cordas. Denunciar que uma estrutura religiosa reproduz a lógica do Estado-Templo não é negar a fé; é afirmar que a fé é grande demais para caber em CNPJ."
  - pergunta: "Existe saída para quem não se encaixa nas igrejas institucionais?"
    resposta: "A proposta de Jesus na Última Ceia foi exatamente essa: comunidade sem mediador, graça sem pedágio, sagrado sem portão de acesso. O movimento dos desigrejados não é apostasia — pode ser o retorno mais fiel à ekklesia original: pessoas reunidas fora das estruturas de poder, ao redor de uma mesa comum."
---
